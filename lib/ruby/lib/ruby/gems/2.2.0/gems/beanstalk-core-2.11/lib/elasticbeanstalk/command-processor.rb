            ...
            if execute_command?(cmd_req)
                ...
                HealthdReporter.log(cmd_req, manifest) do
                    execute_command(cmd_req) do
                        ...
                        begin
                            Activity.create(name: activity_name(command_label, cmd_req, manifest),
                                            timeout: cmd_req.timeout_limit) do
                        ...
                        rescue ActivityTimeoutError => e
                            cmd_result = CommandResult.new(status: CommandResult::INST_TIMEOUT,
                                                           return_code: CommandResult::TIMEOUT_ERROR_CODE,
